...
const seed = async () => {
  try {
    ...
    const user1 = await User.create({
      ...
      avatar:
        'https://ui-avatars.com/api/?name=John+Doe&background=FF0000&color=fff',
    });
    ...
    const user2 = await User.create({
      ...
      password: 'password123',
      avatar:
        'https://ui-avatars.com/api/?name=Jane+Doe&background=0000FF&color=fff',
    });
    ...
    const channel1 = await Channel.create({
      ...
      channelBanner:
        'https://via.placeholder.com/1280x350?text=Code+with+John',
      subscribers: 5200,
    });
    ...
    const videosData = [
      ...
      },
      {
        ...
        description:
          'Arrays, Linked Lists, Trees, Graphs explained simply.',
      ...
      },
      {
        ...
        description:
          'Learn Python from scratch in this beginner-friendly course.',
    ...
    await Channel.findByIdAndUpdate(channel1._id, {
      $push: {
        videos: {
          $each: videos.map((video) => video._id),
        },
      },
    });
    ...
    console.log(
      '👤 Login Test -> Email: john@example.com | Password: password123'
    );
